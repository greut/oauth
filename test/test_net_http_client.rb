...
class NetHTTPClientTest < Test::Unit::TestCase
  ...
  def test_that_using_auth_headers_on_get_requests_works_with_plaintext
    ...
    assert_equal 'GET', request.method
    assert_equal '/test?key=value', request.path
    assert_equal "OAuth oauth_consumer_key=\"consumer_key_86cad9\", oauth_nonce=\"225579211881198842005988698334675835446\", oauth_signature_method=\"PLAINTEXT\", oauth_token=\"token_411a7f\", oauth_timestamp=\"1199645624\", oauth_signature=\"5888bf0345e5d237%263196ffd991c8ebdb\", oauth_version=\"1.0\"".split(', ').sort, request['authorization'].split(', ').sort
  end
